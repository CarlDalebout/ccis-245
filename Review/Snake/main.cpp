...
{
public:
    Snake(Surface * psurface, int x = 2, int y = 3, int dir = 1)
        :head_(psurface, x, y, dir), body_(psurface, x, y, dir)
    {}
    ...
    void move(int direction, Apple & a)
    {
        int x = head_.x();
        int y = head_.y();
